...
// Google Sheet ID and range
const SPREADSHEET_ID = '17-VrmiZQ7lcM7lIwS9LJ2kgTGiNs2qm4NpPlMA1jbF8'; // Replace with your actual ID
const RANGE = 'Sheet1!A1';
        ...
        switch (state.step) {
            ...
            case 'select_service':
                if (arg.startsWith('service_')) {
                    ...
                    await sock.sendMessage(chatId, {
                        text: 'Please select a service from the buttons below:',
            ...
            case 'select_time':
                if (arg.startsWith('time_')) {
                    ...
                    await sock.sendMessage(chatId, {
                        text: 'Please select a time slot from the buttons below:',
